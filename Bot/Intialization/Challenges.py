...
class Challenger:
    ...
    def __str__(self):
        return str({"id":self._id, "username":self._userName, "online":self._online, "perfs":self._perfs, "age":{"createdAt":self._creationDate, "days":self.getAgeDays(), "years":self.getAgeYears()}, "url": self._url})
class Challenge:
